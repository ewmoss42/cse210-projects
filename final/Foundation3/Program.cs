...
class Program
{
    static void Main(string[] args)
    {
        ...
        ReceptionEvent RE = new ReceptionEvent("Reception", "Carrie & Devan's Wedding", "A small reception to celebrate our wedding", "April 8th", "8pm", "204 Johnson rd, Blackfoot ID 83221", "ubenhaded@gmail.com");
